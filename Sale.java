...
public class Sale extends EscapeDialog {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(Alignment.TRAILING)
                    ...
                    .addComponent(downButton, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 23, Short.MAX_VALUE)
        ...
        idTextField.setFont(new Font("Tahoma", 0, 18));
        idTextField.setName("idTextField"); // NOI18N

        dateTextField.setEditable(false);
        dateTextField.setFont(new Font("Tahoma", 0, 18));
        ...
        totalTextField.setFont(new Font("Tahoma", 0, 18));
        ...
        operatorTextField.setFont(new Font("Tahoma", 0, 18));
        ...
        taxTextField.setFont(new Font("Tahoma", 0, 18));
        ...
        cashTextField.setFont(new Font("Tahoma", 0, 18));
        ...
        chequeTextField.setFont(new Font("Tahoma", 0, 18));
        ...
        debitTextField.setFont(new Font("Tahoma", 0, 18));
        ...
        couponTextField.setFont(new Font("Tahoma", 0, 18));
        ...
        tillIdTextField.setFont(new Font("Tahoma", 0, 18));
        ...
        customerIdTextField.setFont(new Font("Tahoma", 0, 18));
        customerIdTextField.setName("customerIdTextField"); // NOI18N

        wasteText.setEditable(false);
        wasteText.setFont(new Font("Tahoma", 0, 18));
        ...
        customerOrderText.setFont(new Font("Tahoma", 0, 18));
